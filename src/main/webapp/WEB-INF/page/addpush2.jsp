...
<div style="width: 500px;height: 800px">
    <form class="layui-form" action="addpushwithtype" method="post">
        <div class="layui-form-item">
            <input type="hidden" value="${push.ID}" id="ID" name="ID">
            <label class="layui-form-label"><b>标题</b></label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="title" value="${push.title}" disabled="disabled">
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label"><b>链接</b></label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="link" value="${push.link}" disabled>
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label"><b>来源</b></label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="source" value="${push.source}" disabled>
            </div>
        </div>
        <div class="layui-form-item">
